...
QtObject {
    property ThemeModel defaults

    // Colors
    property string colors_primary: defaults.colors_primary
    property string colors_onPrimary: defaults.colors_onPrimary
    property string colors_primaryContainer: defaults.colors_primaryContainer
    property string colors_onPrimaryContainer: defaults.colors_onPrimaryContainer
    property string colors_secondary: defaults.colors_secondary
    property string colors_onSecondary: defaults.colors_onSecondary
    property string colors_secondaryContainer: defaults.colors_secondaryContainer
    property string colors_onSecondaryContainer: defaults.colors_onSecondaryContainer
    property string colors_tertiary: defaults.colors_tertiary
    property string colors_onTertiary: defaults.colors_onTertiary
    property string colors_tertiaryContainer: defaults.colors_tertiaryContainer
    property string colors_onTertiaryContainer: defaults.colors_onTertiaryContainer
    property string colors_error: defaults.colors_error
    property string colors_onError: defaults.colors_onError
    property string colors_errorContainer: defaults.colors_errorContainer
    property string colors_onErrorContainer: defaults.colors_onErrorContainer
    property string colors_background: defaults.colors_background
    property string colors_onBackground: defaults.colors_onBackground
    property string colors_surface: defaults.colors_surface
    property string colors_onSurface: defaults.colors_onSurface
    property string colors_surfaceVariant: defaults.colors_surfaceVariant
    property string colors_onSurfaceVariant: defaults.colors_onSurfaceVariant
    property string colors_outline: defaults.colors_outline
    property string colors_shadow: defaults.colors_shadow

    // Typography
    property string typography_fontFamily: defaults.typography_fontFamily
    property int typography_largeSize: defaults.typography_largeSize
    property int typography_largeWeight: defaults.typography_largeWeight
    property int typography_mediumSize: defaults.typography_mediumSize
    property int typography_mediumWeight: defaults.typography_mediumWeight
    property int typography_smallSize: defaults.typography_smallSize
    property int typography_smallWeight: defaults.typography_smallWeight

    // Shapes
    property int shapes_cornerSmall: defaults.shapes_cornerSmall
    property int shapes_cornerMedium: defaults.shapes_cornerMedium
    property int shapes_cornerLarge: defaults.shapes_cornerLarge

    // Spacing
    property int spacing_sm: defaults.spacing_sm
    property int spacing_md: defaults.spacing_md
    property int spacing_lg: defaults.spacing_lg
